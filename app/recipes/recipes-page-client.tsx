                ...
                {data.categories.map((cat: RecipeCategory) => (
                  <CarouselItem key={cat.id} className="pl-4 basis-1/2 md:basis-1/5 lg:basis-1/6 2xl:basis-1/6">
                    <div 
                      ...
                      className={`relative h-[140px] md:h-[160px] lg:h-[115px] 2xl:h-[130px] rounded-4xl lg:rounded-2xl 2xl:rounded-3xl overflow-hidden group cursor-pointer shadow-sm transition-all ${
              ...
              >
                <div className="relative aspect-square w-full rounded-[48px] lg:rounded-[32px] 2xl:rounded-[36px] overflow-hidden bg-white shadow-lg group-hover:shadow-2xl transition-shadow duration-300 mb-8 lg:mb-5 2xl:mb-5">
                  ...
                  <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300">
                    <span className="inline-flex items-center rounded-full bg-white/95 px-5 py-2 text-sm font-bold tracking-wide text-[#0F8DAB] shadow-lg">
                      View Recipe
                    </span>
                  </div>

                  {(item.featured || item.price !== "Free") && (
                    <div
