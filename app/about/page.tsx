...
export default function About() {
  return (
    <main className="w-full bg-white antialiased">
      {/* --- HERO SECTION --- */}
      <section className="relative w-full min-h-[500px] md:h-screen max-h-[900px] overflow-hidden flex items-center bg-[#1a1a1a]">
        ...
        <div className="relative z-10 container mx-auto px-6 md:px-12 lg:px-20">
          <div className="flex flex-col gap-8 md:gap-10">
            <h1 className="font-bebas text-6xl md:text-7xl lg:text-9xl leading-[0.9] tracking-tight uppercase text-white">
              Hey There!
              <br />
              I'm Amber
            </h1>

            <div className="w-full max-w-2xl flex flex-col gap-6 font-metropolis text-lg md:text-xl lg:text-2xl leading-relaxed tracking-tight text-white">
