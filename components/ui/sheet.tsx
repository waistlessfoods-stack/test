...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-white p-6 shadow-[0_20px_60px_rgba(0,0,0,0.15)] transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-200 data-[state=open]:duration-300",
  {
    variants: {
      side: {
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Title
    ref={ref}
    className={cn("text-lg font-semibold text-[#1C1C1C]", className)}
    {...props}
  />
))
